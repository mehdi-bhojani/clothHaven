          ...
          <header className="header__section">
                ...
                <div className="header__topbar--inner d-flex align-items-center justify-content-between">
                  <div className="header__shipping">
                    <ul className="header__shipping--wrapper d-flex">
                      <li className="header__shipping--text text-white">Welcome to Cloths Haven online Store</li>
                      <li className="header__shipping--text text-white d-sm-2-none"><img className="header__shipping--text__icon" src="assets/img/icon/email.png" alt="email-icon" /> <a className="header__shipping--text__link" to="mailto:demo@gmail.com">info@clothsHaven.com</a></li>
                    </ul>
                  </div>
                  <div className="language__currency d-none d-lg-block">
                    <ul className="d-flex align-items-center">
                      <li className="language__currency--list">
                        <a className="language__switcher text-white" to="#">
                        ...
                        <div className="dropdown__language">
                          <ul>
                            <li className="language__items"><a className="language__text" to="#">France</a></li>
                            <li className="language__items"><a className="language__text" to="#">Russia</a></li>
                            <li className="language__items"><a className="language__text" to="#">Spanish</a></li>
                          </ul>
                        </div>
                      </li>
                      <li className="language__currency--list">
                        <a className="account__currency--link text-white" to="#">
                        ...
                        <div className="dropdown__currency">
                          <ul>
                            <li className="currency__items"><a className="currency__text" to="#">CAD</a></li>
                            <li className="currency__items"><a className="currency__text" to="#">CNY</a></li>
                            <li className="currency__items"><a className="currency__text" to="#">EUR</a></li>
                            <li className="currency__items"><a className="currency__text" to="#">GBP</a></li>
                          </ul>
                        </div>
                      </li>
                    </ul>
              ...
              <div className="container-fluid">
                <div className="main__header--inner position__relative d-flex justify-content-between align-items-center">
                  <div className="offcanvas__header--menu__open ">
                    <a className="offcanvas__header--menu__open--btn" to="javascript:void(0)" data-offcanvas>
                  ...
                  <div className="main__logo">
                    <h1 className="main__logo--title"><NavLink className="main__logo--link" to="/"><img className="main__logo--img" src="assets/img/logo/nav-log.png" alt="logo-img" /></NavLink></h1>
                  </div>
                  
                  <div className="header__account header__sticky--none">
                    <ul className="d-flex">
                      <li className="header__account--items">
                        <NavLink className="header__account--btn" to="account">
                      ...
                      <li className="header__account--items d-none d-lg-block">
                        <NavLink style={{display: "none"}} className="header__account--btn" to="wishlist">
                      ...
                      <li className="header__account--items">
                        <NavLink className="header__account--btn minicart__open--btn" to="cart" data-offcanvas>
                  ...
                  <div className="header__menu d-none header__sticky--block d-lg-block">
                    <nav className="header__menu--navigation">
                      <ul className="d-flex">
                        ...
                        <li className="header__menu--items style2">
                          <a className="header__menu--link" to="account">My Account </a>  
                        </li>
                        <li className="header__menu--items style2 d-none d-xl-block">
                          <a className="header__menu--link" to="shop">Categories </a>  
                        </li>
                        <li className="header__menu--items style2">
                          <a className="header__menu--link" to="#">Categories
                          ...
                          <ul className="header__sub--menu">
                            <li className="header__sub--menu__items"><a to="about.html" className="header__sub--menu__link">Men</a></li>
                            <li className="header__sub--menu__items"><a to="contact.html" className="header__sub--menu__link">Women</a></li>
                            <li className="header__sub--menu__items"><a to="cart.html" className="header__sub--menu__link">Children</a></li>
                          </ul>
                        </li>
                        <li className="header__menu--items style2">
                  ...
                  <div className="header__account header__account2 header__sticky--block">
                    <ul className="d-flex">
                      <li className="header__account--items header__account2--items  header__account--search__items d-none d-lg-block">
                        <a className="header__account--btn search__open--btn" to="javascript:void(0)" data-offcanvas>
                      ...
                      <li className="header__account--items header__account2--items">
                        <a className="header__account--btn" to="my-account.html">
                          <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 512 512"><path d="M344 144c-3.92 52.87-44 96-88 96s-84.15-43.12-88-96c-4-55 35-96 88-96s92 42 88 96z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} /><path d="M256 304c-87 0-175.3 48-191.64 138.6C62.39 453.52 68.57 464 80 464h352c11.44 0 17.62-10.48 15.65-21.4C431.3 352 343 304 256 304z" fill="none" stroke="currentColor" strokeMiterlimit={10} strokeWidth={32} /></svg>
                      ...
                      <li className="header__account--items header__account2--items d-none d-lg-block">
                        <a className="header__account--btn" to="wishlist.html">
                          <svg xmlns="http://www.w3.org/2000/svg" width="28.51" height="23.443" viewBox="0 0 512 512"><path d="M352.92 80C288 80 256 144 256 144s-32-64-96.92-64c-52.76 0-94.54 44.14-95.08 96.81-1.1 109.33 86.73 187.08 183 252.42a16 16 0 0018 0c96.26-65.34 184.09-143.09 183-252.42-.54-52.67-42.32-96.81-95.08-96.81z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={32} /></svg>
                          <span className="items__count  wishlist style2">02</span> 
                        </a>
                      </li>
                      <li className="header__account--items header__account2--items">
                        <a className="header__account--btn minicart__open--btn" to="javascript:void(0)" data-offcanvas>
                          <svg xmlns="http://www.w3.org/2000/svg" width="26.51" height="23.443" viewBox="0 0 14.706 13.534">
                            <g transform="translate(0 0)">
                              <g>
                                <path data-name="Path 16787" d="M4.738,472.271h7.814a.434.434,0,0,0,.414-.328l1.723-6.316a.466.466,0,0,0-.071-.4.424.424,0,0,0-.344-.179H3.745L3.437,463.6a.435.435,0,0,0-.421-.353H.431a.451.451,0,0,0,0,.9h2.24c.054.257,1.474,6.946,1.555,7.33a1.36,1.36,0,0,0-.779,1.242,1.326,1.326,0,0,0,1.293,1.354h7.812a.452.452,0,0,0,0-.9H4.74a.451.451,0,0,1,0-.9Zm8.966-6.317-1.477,5.414H5.085l-1.149-5.414Z" transform="translate(0 -463.248)" fill="currentColor" />
                    ...
                    <nav className="header__menu--navigation">
                      <ul className="d-flex">
                        ...
                        <li className="header__menu--items mega__menu--items">
                          <NavLink className="header__menu--link" to="/shop">Shop 
                          </NavLink>
                        </li>
                        <li className="header__menu--items">
                          <NavLink className="header__menu--link" to="/account">Account </NavLink>  
                        </li>
                        <li className="header__menu--items">
                          <a className="header__menu--link" to="#">Categories
                            <svg className="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width={12} height="7.41" viewBox="0 0 12 7.41">
                          ...
                          <ul className="header__sub--menu">
                            <li className="header__sub--menu__items"><a to="shop" className="header__sub--menu__link">Men</a></li>
                            <li className="header__sub--menu__items"><a to="shop" className="header__sub--menu__link">Women</a></li>
                            <li className="header__sub--menu__items"><a to="shop" className="header__sub--menu__link">Children</a></li>
                          </ul>
                        </li>
                        <li className="header__menu--items">
                          <NavLink className="header__menu--link" to="contact">Contact </NavLink>  
            ...
            <div className="offcanvas__header">
              <div className="offcanvas__inner">
                <div className="offcanvas__logo">
                  <NavLink className="offcanvas__logo_link" to="/">
                ...
                <nav className="offcanvas__menu">
                  <ul className="offcanvas__menu_ul">
                    <li className="offcanvas__menu_li">
                      <a className="offcanvas__menu_item" to="/">Home</a>
                      <ul className="offcanvas__sub_menu">
                        <li className="offcanvas__sub_menu_li"><a to="index.html" className="offcanvas__sub_menu_item">Home One</a></li>
                        <li className="offcanvas__sub_menu_li"><a to="index-2.html" className="offcanvas__sub_menu_item">Home Two</a></li>
                        <li className="offcanvas__sub_menu_li"><a to="index-3.html" className="offcanvas__sub_menu_item">Home Three</a></li>
                      </ul>
                    </li>
                    <li className="offcanvas__menu_li">
                      <a className="offcanvas__menu_item" to="#">Shop</a>
                      <ul className="offcanvas__sub_menu">
                        <li className="offcanvas__sub_menu_li">
                          <a to="#" className="offcanvas__sub_menu_item">Column One</a>
                          <ul className="offcanvas__sub_menu">
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="shop.html">Shop Left Sidebar</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="shop-right-sidebar.html">Shop Right Sidebar</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="shop-grid.html">Shop Grid</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="shop-grid-list.html">Shop Grid List</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="shop-list.html">Shop List</a></li>
                          </ul>
                        </li>
                        <li className="offcanvas__sub_menu_li">
                          <a to="#" className="offcanvas__sub_menu_item">Column Two</a>
                          <ul className="offcanvas__sub_menu">
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="product-details.html">Product Details</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="product-video.html">Video Product</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="product-details.html">Variable Product</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="product-left-sidebar.html">Product Left Sidebar</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="product-gallery.html">Product Gallery</a></li>
                          </ul>
                        </li>
                        <li className="offcanvas__sub_menu_li">
                          <a to="#" className="offcanvas__sub_menu_item">Column Three</a>
                          <ul className="offcanvas__sub_menu">
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="my-account.html">My Account</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="my-account-2.html">My Account 2</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="404.html">404 Page</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="login.html">Login Page</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="faq.html">Faq Page</a></li>
                          </ul>
                        </li>
                        <li className="offcanvas__sub_menu_li">
                          <a to="#" className="offcanvas__sub_menu_item">Column Three</a>
                          <ul className="offcanvas__sub_menu">
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="compare.html">Compare Pages</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="checkout.html">Checkout page</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="checkout-2.html">Checkout Style 2</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="checkout-3.html">Checkout Style 3</a></li>
                            <li className="offcanvas__sub_menu_li"><a className="offcanvas__sub_menu_item" to="checkout-4.html">Checkout Style 4</a></li>
                          </ul>
                        </li>
                      </ul>
                    </li>
                    <li className="offcanvas__menu_li"><a className="offcanvas__menu_item" to="about.html">About</a></li>
                    <li className="offcanvas__menu_li"><NavLink className="offcanvas__menu_item" to="contact">Contact</NavLink></li>
                  </ul>
                  <div className="offcanvas__account--items">
                    <a className="offcanvas__account--items__btn d-flex align-items-center" to="login.html">
                  ...
                  <div className="language__currency">
                    <ul className="d-flex align-items-center">
                      <li className="language__currency--list">
                        <a className="offcanvas__language--switcher" to="#">
                          <img className="language__switcher--icon__img" src="assets/img/icon/language-icon.png" alt="currency" />
                          <span>English</span> 
                          <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05" viewBox="0 0 9.797 6.05">
                            <path d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7" />
                      ...
                      <li className="language__currency--list">
                        <a className="offcanvas__account--currency__menu" to="#">
                          <img src="assets/img/icon/usd-icon.png" alt="currency" />
                          <span>$ US Dollar</span> 
                          <svg xmlns="http://www.w3.org/2000/svg" width="11.797" height="9.05" viewBox="0 0 9.797 6.05">
                            <path d="M14.646,8.59,10.9,12.329,7.151,8.59,6,9.741l4.9,4.9,4.9-4.9Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7" />
            ...
            <div className="offcanvas__stikcy--toolbar">
              <ul className="d-flex justify-content-between">
                <li className="offcanvas__stikcy--toolbar__list">
                  <a className="offcanvas__stikcy--toolbar__btn" to="index.html">
                ...
                <li className="offcanvas__stikcy--toolbar__list">
                  <a className="offcanvas__stikcy--toolbar__btn" to="shop.html">
                    <span className="offcanvas__stikcy--toolbar__icon"> 
                ...
                <li className="offcanvas__stikcy--toolbar__list ">
                  <a className="offcanvas__stikcy--toolbar__btn search__open--btn" to="javascript:void(0)" data-offcanvas>
                    <span className="offcanvas__stikcy--toolbar__icon"> 
                ...
                <li className="offcanvas__stikcy--toolbar__list">
                  <a className="offcanvas__stikcy--toolbar__btn minicart__open--btn" to="javascript:void(0)" data-offcanvas>
                    <span className="offcanvas__stikcy--toolbar__icon"> 
                ...
                <li className="offcanvas__stikcy--toolbar__list">
                  <a className="offcanvas__stikcy--toolbar__btn" to="wishlist.html">
                    <span className="offcanvas__stikcy--toolbar__icon"> 
            ...
            <div className="offCanvas__minicart">
              ...
              <div className="minicart__product">
                <div className="minicart__product--items d-flex">
                  <div className="minicart__thumb">
                    <a to="product-details.html"><img src="assets/img/product/product1.png" alt="prduct-img" /></a>
                  </div>
                  <div className="minicart__text">
                    <h3 className="minicart__subtitle h4"><a to="product-details.html">Oversize Cotton Dress</a></h3>
                ...
                <div className="minicart__product--items d-flex">
                  <div className="minicart__thumb">
                    <a to="product-details.html"><img src="assets/img/product/product2.png" alt="prduct-img" /></a>
                  </div>
                  <div className="minicart__text">
                    <h3 className="minicart__subtitle h4"><a to="product-details.html">Boxy Denim Jacket</a></h3>
              ...
              <div className="minicart__conditions text-center">
                ...
                <label className="minicart__conditions--label" htmlFor="accept">I agree with the <a className="minicart__conditions--link" to="privacy-policy.html">Privacy and Policy</a></label>
              </div>
              <div className="minicart__button d-flex justify-content-center">
                <a className="primary__btn minicart__button--link" to="cart.html">View cart</a>
                <a className="primary__btn minicart__button--link" to="checkout.html">Checkout</a>
              </div>
            </div>
