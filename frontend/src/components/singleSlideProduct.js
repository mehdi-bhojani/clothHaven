...
export function SingleSlideProduct(props){
    return(
        <div className="product__items">
              <div className="product__items--thumbnail">
                <a className="product__items--link" href={props.productDetailsLink}>
                  <img
              ...
              <div className="product__items--content">
                ...
                <div className="product__items--price">
                  <span className="current__price">{props.currentPrice}</span>
                  <span className="price__divided" />
                  <span className="old__price">{props.oldPrice}</span>
                </div>
                ...
                <ul className="product__items--action d-flex">
                  <li className="product__items--action__list">
                    <a className="product__items--action__btn add__to--cart" href={props.addToCartLink}>
                  ...
                  <li className="product__items--action__list" >
                    <button className="product__items--action__btn" onClick={props.onAddToWishlist}>
                  ...
                  <li className="product__items--action__list">
                    <a className="product__items--action__btn" data-open="modal1" href={props.quickViewLink}>
