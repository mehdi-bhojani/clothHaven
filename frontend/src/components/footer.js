          ...
          <div className="footer__widget footer__widget--width">
            ...
            <div className="footer__widget--inner">
              <p className="footer__widget--desc text-ofwhite mb-20">
                Welcome to Cloths Haven, where style meets comfort!
                <br /> We curate the latest fashion trends <br />
                to provide you with a diverse collection of high-quality
                clothing.
                <br /> From timeless classics to trendy essentials, our mission
                is
                <br /> to inspire confidence and express individuality through
                fashion. <br />
                Join us on this sartorial journey,
                <br /> where every piece tells a unique story.
              </p>
            ...
            <div className="footer__widget">
              ...
              <ul className="footer__widget--menu footer__widget--inner">
                <li className="footer__widget--menu__list">
                  <NavLink className="footer__widget--menu__text" to="account">
                    My Account
                  </NavLink>
                </li>
                <li className="footer__widget--menu__list">
                  <NavLink className="footer__widget--menu__text" to="cart">
                    Shopping Cart
                  </NavLink>
                </li>
                <li className="footer__widget--menu__list">
                  <NavLink className="footer__widget--menu__text" to="login">
                    Login
                  </NavLink>
                </li>
                <li className="footer__widget--menu__list">
                ...
                <li className="footer__widget--menu__list">
                  <NavLink className="footer__widget--menu__text" to="checkout">
                    Checkout
                  </NavLink>
                </li>
              </ul>
